...
class matrices(base):
    """A wrapper around the PyBullet sim of the robot."""

    def __init__(self, init_q=[np.pi/5.5, np.pi/1.7, np.pi/6.],
                 init_dq=[0., 0., 0.], **kwargs): # initial angles?

        base.__init__(self, init_q=init_q, init_dq=init_dq,
                         **kwargs)
        ...
        l2 = .5
        l3 = .1 # check this
        self.L = np.array([l1, l2, l3]) # numpy create an array
        # mass of links
        m1 = 10
        m2 = m1
        m3 = m1
